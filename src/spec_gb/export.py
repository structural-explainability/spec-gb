# src/spec_gb/export.py
"""Export generated GB machine-readable specification artifacts."""

from dataclasses import asdict, dataclass
import json
from pathlib import Path

from spec_gb.extractor_utils import (
    Requirement,
...
def extract_scope_exclusions(markdown: str) -> list[str]:
    """Extract bullets from the GB.SCOPE.EXCLUSIONS section."""
    ...
    for line in lines:
        ...
        if stripped == "## GB.SCOPE.EXCLUSIONS":
            in_section = True
            continue
    ...
    if not exclusions:
        raise ValueError("No scope exclusions found in GB.SCOPE.EXCLUSIONS.")
