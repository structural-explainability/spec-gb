# src/spec_gb/commands/root.py
"""Root command dispatcher."""

import argparse

from spec_gb.commands.manifest import sync_main
from spec_gb.commands.reference import ref_export_main, ref_validate_main
from spec_gb.commands.validate import validate_main


def main(argv: list[str] | None = None) -> int:
    """Dispatch spec_gb commands."""
    parser = argparse.ArgumentParser(description="spec-gb command line interface.")
